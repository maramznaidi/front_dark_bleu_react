...
const CSS = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* ligne spécifique pour deux champs côte à côte */
  .lp-row {
    display: flex;
    gap: 1rem;
    margin-bottom: 1.2rem;
  ...
  @media (max-width: 680px) {
    ...
    .lp-row { flex-direction: column; gap: 0; }
  }
`;
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(false);
    alert(`Bienvenue ${form.firstName} ! Votre compte a été créé.`);
  };
      ...
      <header className="lp-header">
        ...
        <nav>
          <ul className="lp-nav">
            ...
            <li><Link to="/login" className="lp-nav-register">connexion</Link></li>
          </ul>
        </nav>
      </header>
      ...
      <div className="lp-card-wrap">
        ...
        <div className="lp-card">
          ...
          <h1 className="lp-title">
            Rejoignez<br />notre <span>bibliothèque</span><br />numérique.
          </h1>
          <p className="lp-subtitle">Créez votre compte gratuitement</p>
